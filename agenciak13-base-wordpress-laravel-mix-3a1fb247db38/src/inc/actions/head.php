...
function cb_theme_favicon_assets()
{
    $android = cb_theme_favicon_asset_url('android-icon-192x192.png');
    $android_512 = cb_theme_favicon_asset_url('android-icon-512x512.png');
    ...
    return array(
        ...
        'android'  => $android,
        'manifest' => ($android && $android_512) ? cb_theme_favicon_asset_url('manifest.json') : '',
        'mstile'   => cb_theme_favicon_asset_url('ms-icon-144x144.png'),
    );
}

function cb_disable_wp_site_icon_when_theme_favicon_exists()
{
    if (!array_filter(cb_theme_favicon_assets())) {
        return;
    }
...
add_action('init', 'cb_disable_wp_site_icon_when_theme_favicon_exists', 20);

function cb_render_favicon_tags()
{
    $theme_icons = cb_theme_favicon_assets();
