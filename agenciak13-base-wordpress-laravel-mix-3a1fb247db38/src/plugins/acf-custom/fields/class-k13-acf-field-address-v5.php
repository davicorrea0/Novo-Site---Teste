...
if (!class_exists('k13_acf_field_address')) :


    class k13_acf_field_address extends acf_field
    {
        ...
        */
        ...
        function __construct($settings)
        {
            ...
            */
            ...
            $this->label = __('Endereço', 'acf-address');
...
// initialize
    new k13_acf_field_address($this->settings);
